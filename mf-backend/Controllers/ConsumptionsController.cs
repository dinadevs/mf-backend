...
namespace mf_backend.Controllers
{
    public class ConsumptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Date,Value,Km,FuelType,VehicleId")] Consumption consumption)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Date,Value,Km,FuelType,VehicleId")] Consumption consumption)
        {
